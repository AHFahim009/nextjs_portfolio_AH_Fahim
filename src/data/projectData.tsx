...
export const projectData = [
  {
    ...
    image: lostAndFound,
    category: "Fullstack",
    tech: ["Next JS", "Express", "Prisma", "PostGres", "Material UI"],
    description: "Lost and Found System: Facilitates reporting lost items, posting found items, managing claims, and enables administrators to oversee all application activities",
    live: "",
    github: ""
